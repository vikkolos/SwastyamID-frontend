  ...
  return (
    ...
    <div>
        <div>
            ...
            <div className='flex w-96 h-24 bg-amber-50 rounded-2xl items-center justify-evenly p-3 '>
                <div >
                ...
                <div className='text-black text-lg p-2 '>
                    <h5 className='font-medium '>{ConDocName}</h5>
                    <h6 className='font-semibold text-sm'>Hospital{"  "}:{`${ConDocHospital}`}</h6>
                </div>
